...
public class WishUpdate extends AsyncHttpRequestSample {
	...
	WishUpdateHttpRequest wish_regist_HttpRequest;
	
	public WishUpdate(Context context, String user_id,String wish_id, String wish_option,String title,String descript,String produc_code,String price,String event_date,
			String event_time,String visible_all,String visible_friend_ids,String picked,String filePath, WishUpdateHttpRequest wr) {
		super(context);
            	...
            	try {
					...
					if ( result>0 ) {
						...
						if ( wish_regist_HttpRequest != null ){
							wish_regist_HttpRequest.wish_update_requestSuccess();
						}						
					}					
					else {
						if ( wish_regist_HttpRequest != null )
							wish_regist_HttpRequest.wish_update_requestFailure("");
	...
	public String getDefaultURL() {
		return HttpConstants.WISH_UPDATE;
	}
