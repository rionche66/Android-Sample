...
public class Delete_Wish extends AsyncHttpRequestSample {
	
	private static final String LOG_TAG = "Delete_Message";
	String wish_id;
	
	
	Delete_wish_Request delete_msg_request;
	
	public Delete_Wish(Context context, String wish_id, Delete_wish_Request sm) {
		super(context);
		this.wish_id=wish_id;		
		this.delete_msg_request=sm;
	}
            ...
            public void onSuccess(int statusCode, Header[] headers, byte[] response) {
            	...
            	try {
					...
					if ( result>0 ) {
						...
						if ( delete_msg_request != null )
							delete_msg_request.delete_wish_requestSuccess();	
					}
					else {
						if ( delete_msg_request != null )
							delete_msg_request.delete_wish_requestFailure("");
	...
	public String getDefaultURL() {
		return HttpConstants.DELETE_WISH;
	}
