...
public class Username_Email_search extends AsyncHttpRequestSample {
	...
	public Username_Email_search(Context context,String username, String name,String email,String age_down,String age_up,Search_Result_Request s) {
		super(context);
...
//						AlertUtil.messageAlert(_context, "Search Result", "User not exist!");
					}
					else {
						if ( search_result_request != null )
	...
	public String getDefaultURL() {
		return HttpConstants.USERNAME_SEARCH;
	}
	...
	public RequestHandle executeSample(AsyncHttpClient client, String URL,
		...
		try {
			...
			params.put("age_down", age_down);
			params.put("age_up", age_up);
