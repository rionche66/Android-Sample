...
public class Friend_Invite extends AsyncHttpRequestSample {
	...
	public Friend_Invite(Context context, String user_id,String name, String email, InviteHttpRequest i) {
		super(context);
	...
	public String getDefaultURL() {
		return HttpConstants.INVITE_FRIENDS;
	}
	...
	public RequestHandle executeSample(AsyncHttpClient client, String URL,
		...
		try {
			...
			params.put("friend_username", name);
