...
public class Wish_like extends AsyncHttpRequestSample {
	...
	Wish_likeHttpRequest accept_request;
	
	public Wish_like(Context context, String user_id, String wish_id,int like, Wish_likeHttpRequest i) {
		super(context);
            	...
            	try {
					...
					if ( result.equals("true") ) {
						...
						if ( accept_request != null )
							accept_request.wish_like_requestSuccess();						
					}					
					else {
						if ( accept_request != null )
							accept_request.wish_like_requestFailure("");
	...
	public String getDefaultURL() {
		return HttpConstants.WISH_LIKE;
	}
