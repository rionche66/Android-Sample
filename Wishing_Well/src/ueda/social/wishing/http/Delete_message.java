...
public class Delete_message extends AsyncHttpRequestSample {
	
	private static final String LOG_TAG = "Delete_Message";
	String message_id;
	
	
	Delete_message_Request delete_msg_request;
	
	public Delete_message(Context context, String msg_id, Delete_message_Request sm) {
		super(context);
            	...
            	try {
					...
					if ( result.equals("true") ) {
						...
						if ( delete_msg_request != null )
							delete_msg_request.delete_message_requestSuccess();	
					}
					else {
						if ( delete_msg_request != null )
							delete_msg_request.delete_message_requestFailure("");
	...
	public String getDefaultURL() {
		return HttpConstants.DELETE_MESSAGE;
	}
